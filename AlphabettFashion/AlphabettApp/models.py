...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='photos/shoes')
...
class Watches(models.Model):
    ...
    product_image = models.ImageField(upload_to='photos/watches')
    product_buying_price = models.IntegerField()
    product_selling_price = models.IntegerField()
...
class HomeAppliances(models.Model):
    ...
    product_name = models.CharField(max_length=100)
    product_image = models.ImageField(upload_to='photos/home_appliances')
    product_buying_price = models.IntegerField()
    product_selling_price = models.IntegerField()
